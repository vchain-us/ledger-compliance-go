...
var file_lc_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x75, 0x72, 0x69, 0x73, 0x32, 0xfd, 0x13, 0x0a, 0x09,
...
var file_lc_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_lc_proto_goTypes = []interface{}{
	...
	(*VCNUriUpdateRequest_VCNUriOp)(nil),  // 35: lc.schema.VCNUriUpdateRequest.VCNUriOp
	(*schema.Signature)(nil),              // 36: immudb.schema.Signature
	(*schema.VerifiableTx)(nil),           // 37: immudb.schema.VerifiableTx
	(*schema.ImmutableState)(nil),         // 38: immudb.schema.ImmutableState
	(*schema.VerifiableEntry)(nil),        // 39: immudb.schema.VerifiableEntry
	(*timestamppb.Timestamp)(nil),         // 40: google.protobuf.Timestamp
	(*schema.Entry)(nil),                  // 41: immudb.schema.Entry
	(*schema.ZEntry)(nil),                 // 42: immudb.schema.ZEntry
	(*schema.VerifiableGetRequest)(nil),   // 43: immudb.schema.VerifiableGetRequest
	(*schema.SetRequest)(nil),             // 44: immudb.schema.SetRequest
	(*schema.TxHeader)(nil),               // 45: immudb.schema.TxHeader
	(*schema.InclusionProof)(nil),         // 46: immudb.schema.InclusionProof
	(*schema.KVMetadata)(nil),             // 47: immudb.schema.KVMetadata
	(*schema.KeyRequest)(nil),             // 48: immudb.schema.KeyRequest
	(*schema.VerifiableSetRequest)(nil),   // 49: immudb.schema.VerifiableSetRequest
	(*schema.KeyListRequest)(nil),         // 50: immudb.schema.KeyListRequest
	(*schema.ExecAllRequest)(nil),         // 51: immudb.schema.ExecAllRequest
	(*schema.ScanRequest)(nil),            // 52: immudb.schema.ScanRequest
	(*schema.HistoryRequest)(nil),         // 53: immudb.schema.HistoryRequest
	(*schema.ZAddRequest)(nil),            // 54: immudb.schema.ZAddRequest
	(*schema.VerifiableZAddRequest)(nil),  // 55: immudb.schema.VerifiableZAddRequest
	(*schema.ZScanRequest)(nil),           // 56: immudb.schema.ZScanRequest
	(*emptypb.Empty)(nil),                 // 57: google.protobuf.Empty
	(*schema.Chunk)(nil),                  // 58: immudb.schema.Chunk
	(*schema.Entries)(nil),                // 59: immudb.schema.Entries
	(*schema.ZEntries)(nil),               // 60: immudb.schema.ZEntries
	(*schema.HealthResponse)(nil),         // 61: immudb.schema.HealthResponse
}
var file_lc_proto_depIdxs = []int32{
	4,  // 0: lc.schema.ReportOptions.payload:type_name -> lc.schema.TamperReport
	36, // 1: lc.schema.ReportOptions.signature:type_name -> immudb.schema.Signature
	37, // 2: lc.schema.Response.VerifiableTx:type_name -> immudb.schema.VerifiableTx
	38, // 3: lc.schema.Response.state:type_name -> immudb.schema.ImmutableState
	39, // 4: lc.schema.VerifiableItemExt.item:type_name -> immudb.schema.VerifiableEntry
	40, // 5: lc.schema.VerifiableItemExt.timestamp:type_name -> google.protobuf.Timestamp
	40, // 6: lc.schema.VerifiableItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	41, // 7: lc.schema.ItemExt.item:type_name -> immudb.schema.Entry
	40, // 8: lc.schema.ItemExt.timestamp:type_name -> google.protobuf.Timestamp
	40, // 9: lc.schema.ItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	10, // 10: lc.schema.ItemExtList.items:type_name -> lc.schema.ItemExt
	42, // 11: lc.schema.ZItemExt.item:type_name -> immudb.schema.ZEntry
	40, // 12: lc.schema.ZItemExt.timestamp:type_name -> google.protobuf.Timestamp
	40, // 13: lc.schema.ZItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	12, // 14: lc.schema.ZItemExtList.items:type_name -> lc.schema.ZItemExt
	43, // 15: lc.schema.VerifiableGetExtMultiRequest.requests:type_name -> immudb.schema.VerifiableGetRequest
	9,  // 16: lc.schema.VerifiableGetExtMultiResponse.items:type_name -> lc.schema.VerifiableItemExt
	44, // 17: lc.schema.SetMultiRequest.requests:type_name -> immudb.schema.SetRequest
	45, // 18: lc.schema.SetMultiResponse.transactions:type_name -> immudb.schema.TxHeader
	...
	40, // 23: lc.schema.VCNArtifactsRequest.signedAt:type_name -> google.protobuf.Timestamp
	37, // 24: lc.schema.Proof.verifiableTx:type_name -> immudb.schema.VerifiableTx
	46, // 25: lc.schema.Proof.inclusionProof:type_name -> immudb.schema.InclusionProof
	47, // 26: lc.schema.Proof.metadata:type_name -> immudb.schema.KVMetadata
	45, // 27: lc.schema.VCNArtifactsResponse.transaction:type_name -> immudb.schema.TxHeader
	...
	40, // 30: lc.schema.Entry.timestamp:type_name -> google.protobuf.Timestamp
	40, // 31: lc.schema.Entry.apikeyRevoked:type_name -> google.protobuf.Timestamp
	24, // 32: lc.schema.Entry.proof:type_name -> lc.schema.Proof
	27, // 33: lc.schema.EntryList.entries:type_name -> lc.schema.Entry
	35, // 34: lc.schema.VCNUriUpdateRequest.ops:type_name -> lc.schema.VCNUriUpdateRequest.VCNUriOp
	45, // 35: lc.schema.VCNUriUpdateResponse.transaction:type_name -> immudb.schema.TxHeader
	45, // 36: lc.schema.VCNUriSetResponse.transaction:type_name -> immudb.schema.TxHeader
	3,  // 37: lc.schema.VCNUriUpdateRequest.VCNUriOp.opType:type_name -> lc.schema.VCNUriUpdateRequest.VCNUriOpType
	44, // 38: lc.schema.LcService.Set:input_type -> immudb.schema.SetRequest
	...
	48, // 46: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	49, // 47: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	43, // 48: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	50, // 49: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	51, // 50: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	52, // 51: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	53, // 52: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	54, // 53: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	55, // 54: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	56, // 55: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	57, // 56: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	57, // 57: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	5,  // 58: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	7,  // 59: lc.schema.LcService.SendData:input_type -> lc.schema.Data
	43, // 60: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	15, // 61: lc.schema.LcService.VerifiableGetExtMulti:input_type -> lc.schema.VerifiableGetExtMultiRequest
	56, // 62: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	53, // 63: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	57, // 64: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	48, // 65: lc.schema.LcService.streamGet:input_type -> immudb.schema.KeyRequest
	58, // 66: lc.schema.LcService.streamSet:input_type -> immudb.schema.Chunk
	43, // 67: lc.schema.LcService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	58, // 68: lc.schema.LcService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	52, // 69: lc.schema.LcService.streamScan:input_type -> immudb.schema.ScanRequest
	56, // 70: lc.schema.LcService.streamZScan:input_type -> immudb.schema.ZScanRequest
	53, // 71: lc.schema.LcService.streamHistory:input_type -> immudb.schema.HistoryRequest
	58, // 72: lc.schema.LcService.streamExecAll:input_type -> immudb.schema.Chunk
	45, // 73: lc.schema.LcService.Set:output_type -> immudb.schema.TxHeader
	18, // 74: lc.schema.LcService.SetMulti:output_type -> lc.schema.SetMultiResponse
	25, // 75: lc.schema.LcService.VCNSetArtifacts:output_type -> lc.schema.VCNArtifactsResponse
	28, // 76: lc.schema.LcService.VCNSearchArtifacts:output_type -> lc.schema.EntryList
	28, // 77: lc.schema.LcService.VCNGetArtifacts:output_type -> lc.schema.EntryList
	34, // 78: lc.schema.LcService.VCNUriGet:output_type -> lc.schema.VCNUriGetResponse
	32, // 79: lc.schema.LcService.VCNUriSet:output_type -> lc.schema.VCNUriSetResponse
	30, // 80: lc.schema.LcService.VCNUriUpdate:output_type -> lc.schema.VCNUriUpdateResponse
	41, // 81: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	37, // 82: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	39, // 83: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	59, // 84: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	45, // 85: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxHeader
	59, // 86: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	59, // 87: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	45, // 88: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxHeader
	37, // 89: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	60, // 90: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	38, // 91: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	61, // 92: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	57, // 93: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	8,  // 94: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	9,  // 95: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	16, // 96: lc.schema.LcService.VerifiableGetExtMulti:output_type -> lc.schema.VerifiableGetExtMultiResponse
	13, // 97: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	11, // 98: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	14, // 99: lc.schema.LcService.Feats:output_type -> lc.schema.Features
	58, // 100: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	45, // 101: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxHeader
	58, // 102: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	37, // 103: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	58, // 104: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	58, // 105: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	58, // 106: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
	45, // 107: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxHeader
