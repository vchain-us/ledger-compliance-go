...
func (x *VCNGetRequest) GetSuffix() string {
	if x != nil {
		return x.Suffix
	}
	return ""
...
var file_lc_proto_rawDesc = []byte{
	...
	0x22, 0xee, 0x01, 0x0a, 0x0d, 0x56, 0x43, 0x4e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x02, 0x32, 0xc5, 0x11, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0f, 0x56, 0x43, 0x4e,
	0x47, 0x65, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x12, 0x18, 0x2e, 0x6c,
	0x63, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x47, 0x65, 0x74, 0x52,
...
var file_lc_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_lc_proto_goTypes = []interface{}{
	...
	(*TamperReport)(nil),                  // 2: lc.schema.TamperReport
	(*ReportOptions)(nil),                 // 3: lc.schema.ReportOptions
	(*DataValue)(nil),                     // 4: lc.schema.DataValue
	(*Data)(nil),                          // 5: lc.schema.Data
	(*Response)(nil),                      // 6: lc.schema.Response
	(*VerifiableItemExt)(nil),             // 7: lc.schema.VerifiableItemExt
	(*ItemExt)(nil),                       // 8: lc.schema.ItemExt
	(*ItemExtList)(nil),                   // 9: lc.schema.ItemExtList
	(*ZItemExt)(nil),                      // 10: lc.schema.ZItemExt
	(*ZItemExtList)(nil),                  // 11: lc.schema.ZItemExtList
	(*Features)(nil),                      // 12: lc.schema.Features
	(*VerifiableGetExtMultiRequest)(nil),  // 13: lc.schema.VerifiableGetExtMultiRequest
	(*VerifiableGetExtMultiResponse)(nil), // 14: lc.schema.VerifiableGetExtMultiResponse
	(*SetMultiRequest)(nil),               // 15: lc.schema.SetMultiRequest
	(*SetMultiResponse)(nil),              // 16: lc.schema.SetMultiResponse
	(*VCNAttachment)(nil),                 // 17: lc.schema.VCNAttachment
	(*VCNDependency)(nil),                 // 18: lc.schema.VCNDependency
	(*VCNArtifact)(nil),                   // 19: lc.schema.VCNArtifact
	(*VCNArtifactsRequest)(nil),           // 20: lc.schema.VCNArtifactsRequest
	(*VCNArtifactsResponse)(nil),          // 21: lc.schema.VCNArtifactsResponse
	(*VCNGetRequest)(nil),                 // 22: lc.schema.VCNGetRequest
	(*schema.Signature)(nil),              // 23: immudb.schema.Signature
	(*schema.VerifiableTx)(nil),           // 24: immudb.schema.VerifiableTx
	(*schema.ImmutableState)(nil),         // 25: immudb.schema.ImmutableState
	(*schema.VerifiableEntry)(nil),        // 26: immudb.schema.VerifiableEntry
	(*timestamp.Timestamp)(nil),           // 27: google.protobuf.Timestamp
	(*schema.Entry)(nil),                  // 28: immudb.schema.Entry
	(*schema.ZEntry)(nil),                 // 29: immudb.schema.ZEntry
	(*schema.VerifiableGetRequest)(nil),   // 30: immudb.schema.VerifiableGetRequest
	(*schema.SetRequest)(nil),             // 31: immudb.schema.SetRequest
	(*schema.TxHeader)(nil),               // 32: immudb.schema.TxHeader
	(*schema.KeyRequest)(nil),             // 33: immudb.schema.KeyRequest
	(*schema.VerifiableSetRequest)(nil),   // 34: immudb.schema.VerifiableSetRequest
	(*schema.KeyListRequest)(nil),         // 35: immudb.schema.KeyListRequest
	(*schema.ExecAllRequest)(nil),         // 36: immudb.schema.ExecAllRequest
	(*schema.ScanRequest)(nil),            // 37: immudb.schema.ScanRequest
	(*schema.HistoryRequest)(nil),         // 38: immudb.schema.HistoryRequest
	(*schema.ZAddRequest)(nil),            // 39: immudb.schema.ZAddRequest
	(*schema.VerifiableZAddRequest)(nil),  // 40: immudb.schema.VerifiableZAddRequest
	(*schema.ZScanRequest)(nil),           // 41: immudb.schema.ZScanRequest
	(*empty.Empty)(nil),                   // 42: google.protobuf.Empty
	(*schema.Chunk)(nil),                  // 43: immudb.schema.Chunk
	(*schema.Entries)(nil),                // 44: immudb.schema.Entries
	(*schema.ZEntries)(nil),               // 45: immudb.schema.ZEntries
	(*schema.HealthResponse)(nil),         // 46: immudb.schema.HealthResponse
}
var file_lc_proto_depIdxs = []int32{
	2,  // 0: lc.schema.ReportOptions.payload:type_name -> lc.schema.TamperReport
	23, // 1: lc.schema.ReportOptions.signature:type_name -> immudb.schema.Signature
	24, // 2: lc.schema.Response.VerifiableTx:type_name -> immudb.schema.VerifiableTx
	25, // 3: lc.schema.Response.state:type_name -> immudb.schema.ImmutableState
	26, // 4: lc.schema.VerifiableItemExt.item:type_name -> immudb.schema.VerifiableEntry
	27, // 5: lc.schema.VerifiableItemExt.timestamp:type_name -> google.protobuf.Timestamp
	27, // 6: lc.schema.VerifiableItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	28, // 7: lc.schema.ItemExt.item:type_name -> immudb.schema.Entry
	27, // 8: lc.schema.ItemExt.timestamp:type_name -> google.protobuf.Timestamp
	27, // 9: lc.schema.ItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	8,  // 10: lc.schema.ItemExtList.items:type_name -> lc.schema.ItemExt
	29, // 11: lc.schema.ZItemExt.item:type_name -> immudb.schema.ZEntry
	27, // 12: lc.schema.ZItemExt.timestamp:type_name -> google.protobuf.Timestamp
	27, // 13: lc.schema.ZItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	10, // 14: lc.schema.ZItemExtList.items:type_name -> lc.schema.ZItemExt
	30, // 15: lc.schema.VerifiableGetExtMultiRequest.requests:type_name -> immudb.schema.VerifiableGetRequest
	7,  // 16: lc.schema.VerifiableGetExtMultiResponse.items:type_name -> lc.schema.VerifiableItemExt
	31, // 17: lc.schema.SetMultiRequest.requests:type_name -> immudb.schema.SetRequest
	32, // 18: lc.schema.SetMultiResponse.transactions:type_name -> immudb.schema.TxHeader
	0,  // 19: lc.schema.VCNDependency.type:type_name -> lc.schema.VCNDependency.Type
	18, // 20: lc.schema.VCNArtifact.dependencies:type_name -> lc.schema.VCNDependency
	17, // 21: lc.schema.VCNArtifact.attachments:type_name -> lc.schema.VCNAttachment
	19, // 22: lc.schema.VCNArtifactsRequest.artifacts:type_name -> lc.schema.VCNArtifact
	27, // 23: lc.schema.VCNArtifactsRequest.signedAt:type_name -> google.protobuf.Timestamp
	32, // 24: lc.schema.VCNArtifactsResponse.transaction:type_name -> immudb.schema.TxHeader
	1,  // 25: lc.schema.VCNGetRequest.type:type_name -> lc.schema.VCNGetRequest.Type
	31, // 26: lc.schema.LcService.Set:input_type -> immudb.schema.SetRequest
	15, // 27: lc.schema.LcService.SetMulti:input_type -> lc.schema.SetMultiRequest
	20, // 28: lc.schema.LcService.VCNSetArtifacts:input_type -> lc.schema.VCNArtifactsRequest
	22, // 29: lc.schema.LcService.VCNGetArtifacts:input_type -> lc.schema.VCNGetRequest
	33, // 30: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	34, // 31: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	30, // 32: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	35, // 33: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	36, // 34: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	37, // 35: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	38, // 36: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	39, // 37: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	40, // 38: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	41, // 39: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	42, // 40: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	42, // 41: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	3,  // 42: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	5,  // 43: lc.schema.LcService.SendData:input_type -> lc.schema.Data
	30, // 44: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	13, // 45: lc.schema.LcService.VerifiableGetExtMulti:input_type -> lc.schema.VerifiableGetExtMultiRequest
	41, // 46: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	38, // 47: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	42, // 48: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	33, // 49: lc.schema.LcService.streamGet:input_type -> immudb.schema.KeyRequest
	43, // 50: lc.schema.LcService.streamSet:input_type -> immudb.schema.Chunk
	30, // 51: lc.schema.LcService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	43, // 52: lc.schema.LcService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	37, // 53: lc.schema.LcService.streamScan:input_type -> immudb.schema.ScanRequest
	41, // 54: lc.schema.LcService.streamZScan:input_type -> immudb.schema.ZScanRequest
	38, // 55: lc.schema.LcService.streamHistory:input_type -> immudb.schema.HistoryRequest
	43, // 56: lc.schema.LcService.streamExecAll:input_type -> immudb.schema.Chunk
	32, // 57: lc.schema.LcService.Set:output_type -> immudb.schema.TxHeader
	16, // 58: lc.schema.LcService.SetMulti:output_type -> lc.schema.SetMultiResponse
	21, // 59: lc.schema.LcService.VCNSetArtifacts:output_type -> lc.schema.VCNArtifactsResponse
	11, // 60: lc.schema.LcService.VCNGetArtifacts:output_type -> lc.schema.ZItemExtList
	28, // 61: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	24, // 62: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	26, // 63: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	44, // 64: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	32, // 65: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxHeader
	44, // 66: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	44, // 67: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	32, // 68: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxHeader
	24, // 69: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	45, // 70: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	25, // 71: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	46, // 72: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	42, // 73: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	6,  // 74: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	7,  // 75: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	14, // 76: lc.schema.LcService.VerifiableGetExtMulti:output_type -> lc.schema.VerifiableGetExtMultiResponse
	11, // 77: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	9,  // 78: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	12, // 79: lc.schema.LcService.Feats:output_type -> lc.schema.Features
	43, // 80: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	32, // 81: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxHeader
	43, // 82: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	24, // 83: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	43, // 84: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	43, // 85: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	43, // 86: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
	32, // 87: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxHeader
