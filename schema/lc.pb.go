...
var file_lc_proto_rawDesc = []byte{
	...
	0x32, 0x82, 0x0a, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d,
...
var file_lc_proto_depIdxs = []int32{
	...
	29, // 33: lc.schema.LcService.Set:output_type -> immudb.schema.TxMetadata
	15, // 34: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	11, // 35: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13, // 36: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	30, // 37: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	29, // 38: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxMetadata
	30, // 39: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	30, // 40: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	29, // 41: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxMetadata
	11, // 42: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	31, // 43: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	12, // 44: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	32, // 45: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	28, // 46: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	4,  // 47: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	5,  // 48: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	9,  // 49: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	7,  // 50: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
