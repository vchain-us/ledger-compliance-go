...
var file_lc_proto_rawDesc = []byte{
	...
	0x32, 0xfd, 0x10, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b,
...
var file_lc_proto_goTypes = []interface{}{
	...
	(*schema.TxHeader)(nil),               // 30: immudb.schema.TxHeader
...
var file_lc_proto_depIdxs = []int32{
	...
	30, // 18: lc.schema.SetMultiResponse.transactions:type_name -> immudb.schema.TxHeader
	...
	30, // 24: lc.schema.VCNArtifactsResponse.transaction:type_name -> immudb.schema.TxHeader
	...
	30, // 55: lc.schema.LcService.Set:output_type -> immudb.schema.TxHeader
	...
	30, // 62: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxHeader
	...
	30, // 65: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxHeader
	...
	30, // 78: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxHeader
	...
	30, // 84: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxHeader
