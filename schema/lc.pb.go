...
var file_lc_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x32, 0x82, 0x0a, 0x0a, 0x09, 0x4c, 0x63, 0x53,
	...
	0x49, 0x74, 0x65, 0x6d, 0x45, 0x78, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x36, 0x5a,
...
var file_lc_proto_goTypes = []interface{}{
	...
	(*schema.Entries)(nil),               // 30: immudb.schema.Entries
	(*schema.ZEntries)(nil),              // 31: immudb.schema.ZEntries
...
var file_lc_proto_depIdxs = []int32{
	...
	15, // 31: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	11, // 32: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13, // 33: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	30, // 34: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	29, // 35: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxMetadata
	30, // 36: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	30, // 37: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	29, // 38: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxMetadata
	11, // 39: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	31, // 40: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	12, // 41: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	...
	5,  // 45: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
