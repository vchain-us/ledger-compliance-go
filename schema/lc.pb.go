...
const (
	VCNGetRequest_Any      VCNGetRequest_ArtifactType = 0
	VCNGetRequest_Direct   VCNGetRequest_ArtifactType = 1
	VCNGetRequest_Indirect VCNGetRequest_ArtifactType = 2
	VCNGetRequest_Base     VCNGetRequest_ArtifactType = 3
)
...
var file_lc_proto_rawDesc = []byte{
	...
	0x22, 0x80, 0x03, 0x0a, 0x0d, 0x56, 0x43, 0x4e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x54, 0x53, 0x22, 0x38, 0x0a, 0x04,
	...
	0x75, 0x64, 0x65, 0x73, 0x10, 0x02, 0x22, 0x3b, 0x0a, 0x0c, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61,
	0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x6e, 0x79, 0x10, 0x00, 0x12,
	0x0a, 0x0a, 0x06, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x49,
	0x6e, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x61, 0x73,
	0x65, 0x10, 0x03, 0x32, 0xc5, 0x11, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x0f, 0x56,
	0x43, 0x4e, 0x47, 0x65, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x12, 0x18,
	0x2e, 0x6c, 0x63, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x47, 0x65,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x6c, 0x63, 0x2e, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x5a, 0x49, 0x74, 0x65, 0x6d, 0x45, 0x78, 0x74, 0x4c, 0x69, 0x73,
	0x74, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x69, 0x6d, 0x6d,
...
var file_lc_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_lc_proto_depIdxs = []int32{
	...
	16, // 28: lc.schema.LcService.SetMulti:input_type -> lc.schema.SetMultiRequest
	21, // 29: lc.schema.LcService.VCNSetArtifacts:input_type -> lc.schema.VCNArtifactsRequest
	23, // 30: lc.schema.LcService.VCNGetArtifacts:input_type -> lc.schema.VCNGetRequest
	34, // 31: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	35, // 32: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	31, // 33: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	36, // 34: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	37, // 35: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	38, // 36: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	39, // 37: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	40, // 38: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	41, // 39: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	42, // 40: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	43, // 41: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	43, // 42: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	4,  // 43: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	6,  // 44: lc.schema.LcService.SendData:input_type -> lc.schema.Data
	31, // 45: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	14, // 46: lc.schema.LcService.VerifiableGetExtMulti:input_type -> lc.schema.VerifiableGetExtMultiRequest
	42, // 47: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	39, // 48: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	43, // 49: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	...
	17, // 59: lc.schema.LcService.SetMulti:output_type -> lc.schema.SetMultiResponse
	22, // 60: lc.schema.LcService.VCNSetArtifacts:output_type -> lc.schema.VCNArtifactsResponse
	12, // 61: lc.schema.LcService.VCNGetArtifacts:output_type -> lc.schema.ZItemExtList
	29, // 62: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	25, // 63: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	27, // 64: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	45, // 65: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	33, // 66: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxHeader
	45, // 67: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	45, // 68: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	33, // 69: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxHeader
	25, // 70: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	46, // 71: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	26, // 72: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	47, // 73: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	43, // 74: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	7,  // 75: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	8,  // 76: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	15, // 77: lc.schema.LcService.VerifiableGetExtMulti:output_type -> lc.schema.VerifiableGetExtMultiResponse
	12, // 78: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	10, // 79: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	13, // 80: lc.schema.LcService.Feats:output_type -> lc.schema.Features
