...
var file_lc_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22, 0x69, 0x0a, 0x10,
	...
	0x61, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12,
	...
	0x53, 0x0a, 0x14, 0x56, 0x43, 0x4e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x69,
	0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x32, 0x87, 0x11, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x3d, 0x0a, 0x03, 0x53, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x69, 0x6d, 0x6d, 0x75,
	...
	0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x41, 0x72, 0x74, 0x69, 0x66,
	0x61, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x38,
	...
	0x2e, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x00, 0x12, 0x53, 0x0a, 0x0d, 0x56, 0x65, 0x72, 0x69,
	...
	0x65, 0x72, 0x69, 0x66, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x78, 0x22, 0x00, 0x12, 0x56, 0x0a,
	...
	0x74, 0x72, 0x79, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12,
	...
	0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x45,
	0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63,
	...
	0x6d, 0x61, 0x2e, 0x54, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x12,
	0x3c, 0x0a, 0x04, 0x53, 0x63, 0x61, 0x6e, 0x12, 0x1a, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62,
	...
	0x65, 0x6d, 0x61, 0x2e, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x00, 0x12, 0x42, 0x0a,
	...
	0x00, 0x12, 0x3f, 0x0a, 0x04, 0x5a, 0x41, 0x64, 0x64, 0x12, 0x1a, 0x2e, 0x69, 0x6d, 0x6d, 0x75,
	...
	0x54, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x00, 0x28, 0x01, 0x42, 0x36,
...
var file_lc_proto_depIdxs = []int32{
	...
	25, // 23: lc.schema.VCNArtifactsRequest.signedAt:type_name -> google.protobuf.Timestamp
	30, // 24: lc.schema.VCNArtifactsResponse.transaction:type_name -> immudb.schema.TxMetadata
	29, // 25: lc.schema.LcService.Set:input_type -> immudb.schema.SetRequest
	14, // 26: lc.schema.LcService.SetMulti:input_type -> lc.schema.SetMultiRequest
	19, // 27: lc.schema.LcService.VCNSetArtifacts:input_type -> lc.schema.VCNArtifactsRequest
	31, // 28: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	32, // 29: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	28, // 30: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	33, // 31: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	34, // 32: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	35, // 33: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	36, // 34: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	37, // 35: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	38, // 36: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	39, // 37: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	40, // 38: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	40, // 39: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	2,  // 40: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	4,  // 41: lc.schema.LcService.SendData:input_type -> lc.schema.Data
	28, // 42: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	12, // 43: lc.schema.LcService.VerifiableGetExtMulti:input_type -> lc.schema.VerifiableGetExtMultiRequest
	39, // 44: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	36, // 45: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	40, // 46: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	31, // 47: lc.schema.LcService.streamGet:input_type -> immudb.schema.KeyRequest
	41, // 48: lc.schema.LcService.streamSet:input_type -> immudb.schema.Chunk
	28, // 49: lc.schema.LcService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	41, // 50: lc.schema.LcService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	35, // 51: lc.schema.LcService.streamScan:input_type -> immudb.schema.ScanRequest
	39, // 52: lc.schema.LcService.streamZScan:input_type -> immudb.schema.ZScanRequest
	36, // 53: lc.schema.LcService.streamHistory:input_type -> immudb.schema.HistoryRequest
	41, // 54: lc.schema.LcService.streamExecAll:input_type -> immudb.schema.Chunk
	30, // 55: lc.schema.LcService.Set:output_type -> immudb.schema.TxMetadata
	15, // 56: lc.schema.LcService.SetMulti:output_type -> lc.schema.SetMultiResponse
	20, // 57: lc.schema.LcService.VCNSetArtifacts:output_type -> lc.schema.VCNArtifactsResponse
	26, // 58: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	22, // 59: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	24, // 60: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	42, // 61: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	30, // 62: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxMetadata
	42, // 63: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	42, // 64: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	30, // 65: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxMetadata
	22, // 66: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	43, // 67: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	23, // 68: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	44, // 69: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	40, // 70: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	5,  // 71: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	6,  // 72: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	13, // 73: lc.schema.LcService.VerifiableGetExtMulti:output_type -> lc.schema.VerifiableGetExtMultiResponse
	10, // 74: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	8,  // 75: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	11, // 76: lc.schema.LcService.Feats:output_type -> lc.schema.Features
	41, // 77: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	30, // 78: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxMetadata
	41, // 79: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	22, // 80: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	41, // 81: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	41, // 82: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	41, // 83: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
	30, // 84: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxMetadata
