...
var file_lc_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x32, 0xc1, 0x03, 0x0a, 0x09, 0x4c, 0x63, 0x53,
...
var file_lc_proto_depIdxs = []int32{
	...
	1,  // 8: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	8,  // 9: lc.schema.LcService.Set:output_type -> immudb.schema.Index
	9,  // 10: lc.schema.LcService.Get:output_type -> immudb.schema.Item
	10, // 11: lc.schema.LcService.SafeSet:output_type -> immudb.schema.Proof
	11, // 12: lc.schema.LcService.SafeGet:output_type -> immudb.schema.SafeItem
	12, // 13: lc.schema.LcService.CurrentRoot:output_type -> immudb.schema.Root
	13, // 14: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	7,  // 15: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
