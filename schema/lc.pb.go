...
var file_lc_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x32, 0xfc, 0x0e, 0x0a, 0x09, 0x4c, 0x63, 0x53, 0x65, 0x72,
	...
	0x61, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x69, 0x6d, 0x6d,
	...
	0x73, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x09, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x47, 0x65, 0x74,
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x54, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x00, 0x28, 0x01, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_lc_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_lc_proto_goTypes = []interface{}{
	...
	(*schema.Signature)(nil),             // 11: immudb.schema.Signature
	(*schema.VerifiableTx)(nil),          // 12: immudb.schema.VerifiableTx
	(*schema.ImmutableState)(nil),        // 13: immudb.schema.ImmutableState
	(*schema.VerifiableEntry)(nil),       // 14: immudb.schema.VerifiableEntry
	(*timestamp.Timestamp)(nil),          // 15: google.protobuf.Timestamp
	(*schema.Entry)(nil),                 // 16: immudb.schema.Entry
	(*schema.ZEntry)(nil),                // 17: immudb.schema.ZEntry
	(*schema.SetRequest)(nil),            // 18: immudb.schema.SetRequest
	(*schema.KeyRequest)(nil),            // 19: immudb.schema.KeyRequest
	(*schema.VerifiableSetRequest)(nil),  // 20: immudb.schema.VerifiableSetRequest
	(*schema.VerifiableGetRequest)(nil),  // 21: immudb.schema.VerifiableGetRequest
	(*schema.KeyListRequest)(nil),        // 22: immudb.schema.KeyListRequest
	(*schema.ExecAllRequest)(nil),        // 23: immudb.schema.ExecAllRequest
	(*schema.ScanRequest)(nil),           // 24: immudb.schema.ScanRequest
	(*schema.HistoryRequest)(nil),        // 25: immudb.schema.HistoryRequest
	(*schema.ZAddRequest)(nil),           // 26: immudb.schema.ZAddRequest
	(*schema.VerifiableZAddRequest)(nil), // 27: immudb.schema.VerifiableZAddRequest
	(*schema.ZScanRequest)(nil),          // 28: immudb.schema.ZScanRequest
	(*empty.Empty)(nil),                  // 29: google.protobuf.Empty
	(*schema.Chunk)(nil),                 // 30: immudb.schema.Chunk
	(*schema.TxMetadata)(nil),            // 31: immudb.schema.TxMetadata
	(*schema.Entries)(nil),               // 32: immudb.schema.Entries
	(*schema.ZEntries)(nil),              // 33: immudb.schema.ZEntries
	(*schema.HealthResponse)(nil),        // 34: immudb.schema.HealthResponse
}
var file_lc_proto_depIdxs = []int32{
	0,  // 0: lc.schema.ReportOptions.payload:type_name -> lc.schema.TamperReport
	11, // 1: lc.schema.ReportOptions.signature:type_name -> immudb.schema.Signature
	12, // 2: lc.schema.Response.VerifiableTx:type_name -> immudb.schema.VerifiableTx
	13, // 3: lc.schema.Response.state:type_name -> immudb.schema.ImmutableState
	14, // 4: lc.schema.VerifiableItemExt.item:type_name -> immudb.schema.VerifiableEntry
	15, // 5: lc.schema.VerifiableItemExt.timestamp:type_name -> google.protobuf.Timestamp
	15, // 6: lc.schema.VerifiableItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	16, // 7: lc.schema.ItemExt.item:type_name -> immudb.schema.Entry
	15, // 8: lc.schema.ItemExt.timestamp:type_name -> google.protobuf.Timestamp
	15, // 9: lc.schema.ItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	6,  // 10: lc.schema.ItemExtList.items:type_name -> lc.schema.ItemExt
	17, // 11: lc.schema.ZItemExt.item:type_name -> immudb.schema.ZEntry
	15, // 12: lc.schema.ZItemExt.timestamp:type_name -> google.protobuf.Timestamp
	15, // 13: lc.schema.ZItemExt.apikeyRevoked:type_name -> google.protobuf.Timestamp
	8,  // 14: lc.schema.ZItemExtList.items:type_name -> lc.schema.ZItemExt
	18, // 15: lc.schema.LcService.Set:input_type -> immudb.schema.SetRequest
	19, // 16: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	20, // 17: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	21, // 18: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	22, // 19: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	23, // 20: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	24, // 21: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	25, // 22: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	26, // 23: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	27, // 24: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	28, // 25: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	29, // 26: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	29, // 27: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	...
	21, // 30: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	28, // 31: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	25, // 32: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	29, // 33: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	19, // 34: lc.schema.LcService.streamGet:input_type -> immudb.schema.KeyRequest
	30, // 35: lc.schema.LcService.streamSet:input_type -> immudb.schema.Chunk
	21, // 36: lc.schema.LcService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	30, // 37: lc.schema.LcService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	24, // 38: lc.schema.LcService.streamScan:input_type -> immudb.schema.ScanRequest
	28, // 39: lc.schema.LcService.streamZScan:input_type -> immudb.schema.ZScanRequest
	25, // 40: lc.schema.LcService.streamHistory:input_type -> immudb.schema.HistoryRequest
	30, // 41: lc.schema.LcService.streamExecAll:input_type -> immudb.schema.Chunk
	31, // 42: lc.schema.LcService.Set:output_type -> immudb.schema.TxMetadata
	16, // 43: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	12, // 44: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	14, // 45: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	32, // 46: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	31, // 47: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxMetadata
	32, // 48: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	32, // 49: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	31, // 50: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxMetadata
	12, // 51: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	33, // 52: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	13, // 53: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	34, // 54: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	29, // 55: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	4,  // 56: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	5,  // 57: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	9,  // 58: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	7,  // 59: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	10, // 60: lc.schema.LcService.Feats:output_type -> lc.schema.Features
	30, // 61: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	31, // 62: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxMetadata
	30, // 63: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	12, // 64: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	30, // 65: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	30, // 66: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	30, // 67: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
	31, // 68: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxMetadata
