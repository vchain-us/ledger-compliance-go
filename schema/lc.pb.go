...
var file_lc_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x32, 0xfe, 0x0d, 0x0a, 0x09, 0x4c, 0x63, 0x53,
	...
	0x14, 0x2e, 0x69, 0x6d, 0x6d, 0x75, 0x64, 0x62, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74,
...
var file_lc_proto_depIdxs = []int32{
	...
	30, // 37: lc.schema.LcService.Set:output_type -> immudb.schema.TxMetadata
	15, // 38: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	11, // 39: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	13, // 40: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	31, // 41: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	30, // 42: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxMetadata
	31, // 43: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	31, // 44: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	30, // 45: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxMetadata
	11, // 46: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	32, // 47: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	12, // 48: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	33, // 49: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	28, // 50: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	4,  // 51: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	5,  // 52: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	9,  // 53: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	7,  // 54: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	29, // 55: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	30, // 56: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxMetadata
	29, // 57: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	11, // 58: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	29, // 59: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	29, // 60: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	29, // 61: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
