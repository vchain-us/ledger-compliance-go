...
type VCNLabelsSetRequests struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *VCNLabelsSetRequests) Reset() {
	*x = VCNLabelsSetRequests{}
	if protoimpl.UnsafeEnabled {
...
func (x *VCNLabelsSetRequests) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VCNLabelsSetRequests) ProtoMessage() {}

func (x *VCNLabelsSetRequests) ProtoReflect() protoreflect.Message {
	mi := &file_lc_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VCNLabelsSetRequests.ProtoReflect.Descriptor instead.
func (*VCNLabelsSetRequests) Descriptor() ([]byte, []int) {
	return file_lc_proto_rawDescGZIP(), []int{28}
}

func (x *VCNLabelsSetRequests) GetRequest() []*VCNLabelsSetRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
var file_lc_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x50, 0x0a, 0x14, 0x56, 0x43, 0x4e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x53, 0x65,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x12, 0x38, 0x0a, 0x07, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x63, 0x2e,
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43, 0x4e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x51, 0x0a, 0x14, 0x56, 0x43, 0x4e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	...
	0x0c, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x32, 0xf8, 0x14,
	...
	0x00, 0x12, 0x52, 0x0a, 0x0c, 0x56, 0x43, 0x4e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x53, 0x65,
	0x74, 0x12, 0x1f, 0x2e, 0x6c, 0x63, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x43,
	0x4e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x73, 0x1a, 0x1f, 0x2e, 0x6c, 0x63, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56,
	...
	0x2e, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x07, 0x45, 0x78,
	...
	0x00, 0x12, 0x3d, 0x0a, 0x04, 0x5a, 0x41, 0x64, 0x64, 0x12, 0x1a, 0x2e, 0x69, 0x6d, 0x6d, 0x75,
	...
	0x61, 0x64, 0x65, 0x72, 0x22, 0x00, 0x28, 0x01, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
...
var file_lc_proto_goTypes = []interface{}{
	...
	(*VCNLabelsSetRequests)(nil),                // 32: lc.schema.VCNLabelsSetRequests
...
var file_lc_proto_depIdxs = []int32{
	...
	31, // 36: lc.schema.VCNLabelsSetRequests.request:type_name -> lc.schema.VCNLabelsSetRequest
	...
	32, // 45: lc.schema.LcService.VCNLabelsSet:input_type -> lc.schema.VCNLabelsSetRequests
	29, // 46: lc.schema.LcService.VCNLabelsUpdate:input_type -> lc.schema.VCNLabelsUpdateRequest
	36, // 47: lc.schema.LcService.VCNGetAttachment:input_type -> lc.schema.VCNGetAttachmentRequest
	51, // 48: lc.schema.LcService.Get:input_type -> immudb.schema.KeyRequest
	52, // 49: lc.schema.LcService.VerifiableSet:input_type -> immudb.schema.VerifiableSetRequest
	46, // 50: lc.schema.LcService.VerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	53, // 51: lc.schema.LcService.GetAll:input_type -> immudb.schema.KeyListRequest
	54, // 52: lc.schema.LcService.ExecAll:input_type -> immudb.schema.ExecAllRequest
	55, // 53: lc.schema.LcService.Scan:input_type -> immudb.schema.ScanRequest
	56, // 54: lc.schema.LcService.History:input_type -> immudb.schema.HistoryRequest
	57, // 55: lc.schema.LcService.ZAdd:input_type -> immudb.schema.ZAddRequest
	58, // 56: lc.schema.LcService.VerifiableZAdd:input_type -> immudb.schema.VerifiableZAddRequest
	59, // 57: lc.schema.LcService.ZScan:input_type -> immudb.schema.ZScanRequest
	60, // 58: lc.schema.LcService.CurrentState:input_type -> google.protobuf.Empty
	60, // 59: lc.schema.LcService.Health:input_type -> google.protobuf.Empty
	5,  // 60: lc.schema.LcService.ReportTamper:input_type -> lc.schema.ReportOptions
	7,  // 61: lc.schema.LcService.SendData:input_type -> lc.schema.Data
	46, // 62: lc.schema.LcService.VerifiableGetExt:input_type -> immudb.schema.VerifiableGetRequest
	15, // 63: lc.schema.LcService.VerifiableGetExtMulti:input_type -> lc.schema.VerifiableGetExtMultiRequest
	59, // 64: lc.schema.LcService.ZScanExt:input_type -> immudb.schema.ZScanRequest
	56, // 65: lc.schema.LcService.HistoryExt:input_type -> immudb.schema.HistoryRequest
	60, // 66: lc.schema.LcService.Feats:input_type -> google.protobuf.Empty
	51, // 67: lc.schema.LcService.streamGet:input_type -> immudb.schema.KeyRequest
	61, // 68: lc.schema.LcService.streamSet:input_type -> immudb.schema.Chunk
	46, // 69: lc.schema.LcService.streamVerifiableGet:input_type -> immudb.schema.VerifiableGetRequest
	61, // 70: lc.schema.LcService.streamVerifiableSet:input_type -> immudb.schema.Chunk
	55, // 71: lc.schema.LcService.streamScan:input_type -> immudb.schema.ScanRequest
	59, // 72: lc.schema.LcService.streamZScan:input_type -> immudb.schema.ZScanRequest
	56, // 73: lc.schema.LcService.streamHistory:input_type -> immudb.schema.HistoryRequest
	61, // 74: lc.schema.LcService.streamExecAll:input_type -> immudb.schema.Chunk
	48, // 75: lc.schema.LcService.Set:output_type -> immudb.schema.TxHeader
	18, // 76: lc.schema.LcService.SetMulti:output_type -> lc.schema.SetMultiResponse
	25, // 77: lc.schema.LcService.VCNSetArtifacts:output_type -> lc.schema.VCNArtifactsResponse
	28, // 78: lc.schema.LcService.VCNSearchArtifacts:output_type -> lc.schema.EntryList
	28, // 79: lc.schema.LcService.VCNGetArtifacts:output_type -> lc.schema.EntryList
	35, // 80: lc.schema.LcService.VCNLabelsGet:output_type -> lc.schema.VCNLabelsGetResponse
	33, // 81: lc.schema.LcService.VCNLabelsSet:output_type -> lc.schema.VCNLabelsSetResponse
	30, // 82: lc.schema.LcService.VCNLabelsUpdate:output_type -> lc.schema.VCNLabelsUpdateResponse
	37, // 83: lc.schema.LcService.VCNGetAttachment:output_type -> lc.schema.VCNGetAttachmentResponse
	44, // 84: lc.schema.LcService.Get:output_type -> immudb.schema.Entry
	40, // 85: lc.schema.LcService.VerifiableSet:output_type -> immudb.schema.VerifiableTx
	42, // 86: lc.schema.LcService.VerifiableGet:output_type -> immudb.schema.VerifiableEntry
	62, // 87: lc.schema.LcService.GetAll:output_type -> immudb.schema.Entries
	48, // 88: lc.schema.LcService.ExecAll:output_type -> immudb.schema.TxHeader
	62, // 89: lc.schema.LcService.Scan:output_type -> immudb.schema.Entries
	62, // 90: lc.schema.LcService.History:output_type -> immudb.schema.Entries
	48, // 91: lc.schema.LcService.ZAdd:output_type -> immudb.schema.TxHeader
	40, // 92: lc.schema.LcService.VerifiableZAdd:output_type -> immudb.schema.VerifiableTx
	63, // 93: lc.schema.LcService.ZScan:output_type -> immudb.schema.ZEntries
	41, // 94: lc.schema.LcService.CurrentState:output_type -> immudb.schema.ImmutableState
	64, // 95: lc.schema.LcService.Health:output_type -> immudb.schema.HealthResponse
	60, // 96: lc.schema.LcService.ReportTamper:output_type -> google.protobuf.Empty
	8,  // 97: lc.schema.LcService.SendData:output_type -> lc.schema.Response
	9,  // 98: lc.schema.LcService.VerifiableGetExt:output_type -> lc.schema.VerifiableItemExt
	16, // 99: lc.schema.LcService.VerifiableGetExtMulti:output_type -> lc.schema.VerifiableGetExtMultiResponse
	13, // 100: lc.schema.LcService.ZScanExt:output_type -> lc.schema.ZItemExtList
	11, // 101: lc.schema.LcService.HistoryExt:output_type -> lc.schema.ItemExtList
	14, // 102: lc.schema.LcService.Feats:output_type -> lc.schema.Features
	61, // 103: lc.schema.LcService.streamGet:output_type -> immudb.schema.Chunk
	48, // 104: lc.schema.LcService.streamSet:output_type -> immudb.schema.TxHeader
	61, // 105: lc.schema.LcService.streamVerifiableGet:output_type -> immudb.schema.Chunk
	40, // 106: lc.schema.LcService.streamVerifiableSet:output_type -> immudb.schema.VerifiableTx
	61, // 107: lc.schema.LcService.streamScan:output_type -> immudb.schema.Chunk
	61, // 108: lc.schema.LcService.streamZScan:output_type -> immudb.schema.Chunk
	61, // 109: lc.schema.LcService.streamHistory:output_type -> immudb.schema.Chunk
	48, // 110: lc.schema.LcService.streamExecAll:output_type -> immudb.schema.TxHeader
...
func file_lc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lc_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VCNLabelsSetRequests); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
